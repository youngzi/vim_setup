...
" winManager setting
"""""""""""""""""""""""""""""""
let g:winManagerWindowLayout = "BufExplorer,NERDTree|Tagbar"
...
"打开LookupFile
nmap <silent> <leader>lu <Plug>LookupFile<cr>
"打开BuffersFind
...
" tags setting
"""""""""""""""""""""""""""""""
let Tlist_Show_One_File = 1            "Show tags for the modifying file
if filereadable("tags")
    set tags=tags
    let Tlist_Show_One_File = 1
    let Tlist_Exit_OnlyWindow = 1          "Exit vim if taglist is the last window
    "let Tlist_Use_Right_Window = 1         "show tags on the right of the workspace
endif
...
" Multiple cursor for finding and editing files
...
"Highlight whitespaces end of line
highlight WhitespaceEOL ctermbg=red guibg=red
match WhitespaceEOL /\s\+$/

"For android aidl files
